...
function Stat({ label, value, suffix = "", duration = 1200 }) {
    ...
    return (
        <div
            ref={ref}
            className="rounded-2xl bg-[#F5F5F5] border border-white/60 p-6 text-center shadow-[10px_10px_20px_#d6d6d6,_-10px_-10px_20px_#ffffff]"
        >
...
export default function Home() {
    return (
        <div className="space-y-14">
            ...
            {/* ⭐⭐⭐ REVIEW SECTION ⭐⭐⭐ */}
            <section>
                <h2 className="text-2xl sm:text-3xl font-semibold text-[#2E7D32] mb-6">What Our Customers Say</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {[
                        ...
                        },
                        {
                            ...
                            initials: "MG",
                            review:
                                "Despite Diwali holidays, your team completed installation the next day & even visited 2–3 times later to ensure everything worked perfectly!",
                        },
                        {
                            name: "Manoj Sharma",
                            initials: "MS",
                            review:
                                "Best guidance for solar power. Regular follow-ups were impressive. Truly — installation ke saath bhi & installation ke baad bhi!",
                        },
                    ].map((r) => (
                        <div
                            key={r.name}
                            className="bg-[#F5F5F5] border border-white/60 p-6 rounded-2xl shadow-[10px_10px_20px_#d6d6d6,_-10px_-10px_20px_#ffffff] hover:scale-[1.03] transition-transform"
                        >
                            <div className="flex items-center gap-4">
                                <div className="h-12 w-12 rounded-full bg-[#2E7D32] text-white flex items-center justify-center text-lg font-semibold shadow">
                                    {r.initials}
                                </div>
                                <div className="font-semibold text-[#2E7D32] text-lg">{r.name}</div>
                            </div>

                            <p className="mt-3 text-sm text-[#333333]/85 leading-relaxed">{r.review}</p>
                        </div>
                    ))}
