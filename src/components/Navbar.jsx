  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50">
      <div className="mx-auto container px-4 sm:px-6 lg:px-8">
        ...
        <div
          className="flex items-center justify-between rounded-2xl bg-[#F5F5F5] px-4 py-3 shadow-[8px_8px_16px_#d6d6d6,_-8px_-8px_16px_#ffffff] border border-white/60"
        >
          {/* Brand */}
          <Link to="/" className="flex items-center gap-3">
            {/* Clean inline SVG logo (leaf + sun), no external image */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className="h-9 w-9 rounded-2xl shadow-[inset_2px_2px_6px_rgba(0,0,0,0.06),inset_-2px_-2px_6px_rgba(255,255,255,0.9)]"
            >
              <defs>
              ...
              <rect x="0" y="0" width="24" height="24" rx="10" fill="url(#g1)" />
              {/* Leaf */}
              <path d="M6 18c6 0 9-4.5 9-9 2 0 3 1.5 3 3.5 0 4.5-4 6.5-8 6.5-2.3 0-3.8-.7-4.6-1.6" fill="none" stroke="#FFFFFF" strokeWidth="1.4" />
              {/* Sun */}
              <circle cx="16.5" cy="7.5" r="2.2" fill="none" stroke="#FFFFFF" strokeWidth="1.4" />
            </svg>
            <span className="text-xl sm:text-2xl font-semibold tracking-tight text-[#2E7D32]">
              Enersum
            </span>
          </Link>
